 ...
 * @author Chandupa
 */
public class Admin_Inventory_Manager extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Inventory_Manager
     */
    public Admin_Inventory_Manager() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton8.setText("Supplier Registration");
        ...
        jButton9.setText("Order Request");
        ...
        jLabel3.setText("Welcome To Inventory Manager Dashboard");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Inventory_Manager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Inventory_Manager().setVisible(true);
            }
        });
    }
