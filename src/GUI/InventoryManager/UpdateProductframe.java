...
public class UpdateProductframe extends javax.swing.JFrame {
    ...
    public void get(String barcode, String description, String name, String category, String brand) {
    ...
    private void loadCategory() {
        ...
        try {
            ...
            ResultSet resultSet = MySQL.execute("SELECT `category_name` FROM `category`");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            MySQL.execute("UPDATE `product` SET `name`='"+productName+"', `description`='"+description+"'"
                    + ", `brand_id`='"+brand+"', `category_id`='"+category+"' WHERE `barcode`='"+barcode+"'");
