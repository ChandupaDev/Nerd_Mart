 ...
 * @author Shashen
 */
public class Update_Employe extends javax.swing.JFrame {


    public Update_Employe(String nic) {
        initComponents();
    ...
    private void loadDetails(){
        ...
        try {
            ResultSet resultSet = MySQL.execute("SELECT `employee`.`nic`, `employee`.`fname`, `employee`.`lname`, `mobile`,`employee_type`.`type`,`gender`.`name`, `line1`,`line2`,`city`.`name` FROM employee INNER JOIN employee_type ON employee.employee_type_id = employee_type.id INNER JOIN gender ON employee.gender_id = gender.id INNER JOIN city ON employee.city_id = city.id WHERE nic = '"+nic+"' ");
            if(resultSet.next()){
                jTextField2.setText( resultSet.getString("employee.fname"));
                jTextField3.setText(resultSet.getString("employee.lname"));
                jTextField4.setText(resultSet.getString("mobile"));
                jComboBox1.setSelectedItem(resultSet.getString("employee_type.type"));
                jComboBox2.setSelectedItem(resultSet.getString("gender.name"));
                jTextField6.setText(resultSet.getString("line1"));
                jTextField7.setText(resultSet.getString("line2"));
                jComboBox4.setSelectedItem(resultSet.getString("city.name"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
